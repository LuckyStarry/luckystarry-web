...
import { ApplicationBuilder } from '../src/builder'
import { ServiceProvider } from '../src/utils'
import { ServiceCollection } from 'luckystarry-ioc'
import { HttpContext, HttpRequest, HttpResponse } from '../src/http'
...
describe('/application-builder.ts', function() {
  ...
  it('ApplicationBuilder.ApplicationServices 可写', function() {
    let builder = new ApplicationBuilder(new ServiceCollection())
    expect(() => {
